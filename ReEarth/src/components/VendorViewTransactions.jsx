...
function VendorViewTransactions() {
  ...
  const sentRequests = [
    {
      id: 1,
      businessName: "Waste Management Inc",
    ...
    {
      id: 2,
      businessName: "RecycleTech Industries",
...
export default VendorViewTransactions;